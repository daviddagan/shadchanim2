                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            border: Border.all(
                                                width: sSelected == Gender.MALE ? 2.0 : 1.5,
                                                color: sSelected == Gender.MALE
                                                    ? ColorManager.mYTHEME == MYTHEME.DARK ? ColorManager().theme.primary[300] : ColorManager().theme.secondary
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(50),
                                            border: Border.all(
                                                width: sSelected == Gender.FEMALE ? 2.0 : 1.5, color: sSelected == Gender.FEMALE ? ColorManager().theme.primary[300] : ColorManager().theme.primary),
                                          ),
                                          child: IconButton(
                              ...
                              children: <Widget>[
                                FlatButton(
                                  ...
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(30.0), side: BorderSide(color: state.hasError ? Colors.red[300] : ColorManager().theme.darkPrimeryLightGrey)),
                                  //color:  ColorManager().theme.fillOnBackGroundColor,
                                  onPressed: () {
                                      ...
                                      children: <Widget>[
                                        Row(
                                          children: <Widget>[
                                            Text(
                                              dateString,
                                              style: TextStyle(color: ColorManager().theme.darkWhiteLightSecondary, fontWeight: FontWeight.bold, fontSize: 18.0),
                                            ),
                                          ],
                                        ),
                                        FaIcon(
                          ...
                          builder: (FormFieldState<Country> state) {
                            return Column(
                              ...
                              children: <Widget>[
                                ...
                                state.hasError ? Text(state.errorText, style: TextStyle(color: Colors.red[300], fontSize: 12)) : Container()
                              ],
                            );
                          },
                          validator: (val) {
