import 'package:flutter_app/models/conversationModel.dart';
...
class ChatTabScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView.builder(itemCount: conversations.length, itemBuilder: (BuildContext context, index) => conversation(context, conversations[index])),
    );
  }
}
