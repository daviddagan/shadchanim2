...
class _CompareScreenState extends State<CompareScreen> {
  ...
  Widget circleIcon(IconData _icon, String message) {
    return Tooltip(
      message: message,
      child: new Container(
        //width: 50.0,
        ...
        children: <Widget>[
          ...
          Stack(
            children: [
              ...
              Positioned.fill(child: Align(alignment: Alignment.center, child: circleIcon(FontAwesomeIcons.birthdayCake, "גיל"))),
            ],
          ),
          //Country
          Stack(children: [
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                          Text(
                            LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.myPerson.country.toString()),
                            style: TextStyle(color: Colors.black54),
                          ),
                          SizedBox(
                            width: 60,
                            child: Column(
                                ...
                                children: widget.myPerson.countrys.entries
                                    .map((e) => Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
                                        maxLines: 3, style: TextStyle(color: widget.myPerson.countrys[widget.person.country] == true ? Colors.green : Colors.red)))
                                    .toList()),
                          )
                          // Text(
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                        Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.person.country.toString()), style: TextStyle(color: Colors.black54)),
                        SizedBox(
                            width: 60,
                            child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: widget.person.countrys.entries
                                    .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
            ...
            Positioned.fill(child: Align(alignment: Alignment.center, child: circleIcon(FontAwesomeIcons.globeAsia, "אזור"))),
          ]),
          //Area
          Stack(children: [
            Container(
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                          Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.myPerson.area.toString()), style: TextStyle(color: Colors.black54)),
                          SizedBox(
                              width: 60,
                              child: (Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: widget.myPerson.areas.entries
                                      .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                        Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.person.area.toString()), style: TextStyle(color: Colors.black54)),
                        SizedBox(
                            width: 60,
                            child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: widget.person.areas.entries
                                    .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
            ...
            Positioned.fill(child: Align(alignment: Alignment.center, child: circleIcon(FontAwesomeIcons.city, "עיר"))),
          ]),
          //Status
          Stack(children: [
            Container(
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                          Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.myPerson.status.toString()), style: TextStyle(color: Colors.black54)),
                          SizedBox(
                            width: 60,
                            child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: widget.myPerson.statuses.entries
                                    .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                        Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.person.status.toString()), style: TextStyle(color: Colors.black54)),
                        SizedBox(
                            width: 60,
                            child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: widget.person.statuses.entries
                                    .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
            ...
            Positioned.fill(child: Align(alignment: Alignment.center, child: circleIcon(FontAwesomeIcons.userFriends, "סטטוס"))),
          ]),
          //Religious
          Stack(children: [
            Container(
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                          Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.myPerson.dos.toString()), style: TextStyle(color: Colors.black54)),
                          SizedBox(
                              width: 60,
                              child: (Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: widget.myPerson.doses.entries
                                      .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                        Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.person.dos.toString()), style: TextStyle(color: Colors.black54)),
                        SizedBox(
                            width: 60,
                            child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: widget.person.doses.entries
                                    .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
                                        maxLines: 3, style: TextStyle(color: (widget.person.doses[widget.myPerson.dos]) == true ? Colors.green : Colors.red))))
                                    .toList()))
                      ]),
                    ),
                  ))
            ...
            Positioned.fill(child: Align(alignment: Alignment.center, child: circleIcon(FontAwesomeIcons.torah, "רמה דתית"))),
          ]),
          //Hashkafa
          Stack(children: [
            Container(
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                          Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.myPerson.hashkafa.toString()), style: TextStyle(color: Colors.black54)),
                          SizedBox(
                              width: 60,
                              child: (Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: widget.myPerson.hashkafas.entries
                                      .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                        Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.person.hashkafa.toString()), style: TextStyle(color: Colors.black54)),
                        SizedBox(
                            width: 60,
                            child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: widget.person.hashkafas.entries
                                    .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
            ...
            Positioned.fill(child: Align(alignment: Alignment.center, child: circleIcon(FontAwesomeIcons.starOfDavid, "השקפה"))),
          ]),
          //Eda
          Stack(children: [
            Container(
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                          Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.myPerson.eda.toString()), style: TextStyle(color: Colors.black54)),
                          SizedBox(
                              width: 60,
                              child: (Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: widget.myPerson.edas.entries
                                      .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
                                          maxLines: 3, style: TextStyle(color: (widget.myPerson.edas[widget.person.eda]) == true ? Colors.green : Colors.red))))
                                      .toList())))
                        ]),
                      ),
                    ),
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                        Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.person.eda.toString()), style: TextStyle(color: Colors.black54)),
                        SizedBox(
                            width: 60,
                            child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: widget.person.edas.entries
                                    .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
                                        maxLines: 3, style: TextStyle(color: (widget.person.edas[widget.myPerson.eda]) == true ? Colors.green : Colors.red))))
                                    .toList()))
                      ]),
                    ),
                  ))
            ...
            Positioned.fill(child: Align(alignment: Alignment.center, child: circleIcon(FontAwesomeIcons.synagogue, "עדה"))),
          ]),
          //Smoking
          Stack(children: [
            Container(
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                          Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.myPerson.smoke.toString()), style: TextStyle(color: Colors.black54)),
                          SizedBox(
                              width: 60,
                              child: (Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: widget.myPerson.smoking.entries
                                      .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                        Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), widget.person.smoke.toString()), style: TextStyle(color: Colors.black54)),
                        SizedBox(
                            width: 60,
                            child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: widget.person.smoking.entries
                                    .map((e) => (Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()),
            ...
            Positioned.fill(child: Align(alignment: Alignment.center, child: circleIcon(FontAwesomeIcons.smoking, "מעשן"))),
          ]),
          //height
          Stack(children: [
            Container(
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                          Text(widget.myPerson.height.toString(), style: TextStyle(color: Colors.black54)),
                          SizedBox(
                              width: 60,
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Row(
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                        Text(widget.person.height.toString(), style: TextStyle(color: Colors.black54)),
                        SizedBox(
                            width: 60,
                            child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Row(
            ...
            Positioned.fill(child: Align(alignment: Alignment.center, child: circleIcon(FontAwesomeIcons.ruler, "גובה"))),
          ]),
          //sherut
          Stack(children: [
            Container(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                          Column(
                            ...
                            children: widget.myPerson.gender == Gender.MALE
                                ? widget.myPerson.mySherutBoy != null
                                    ? widget.myPerson.mySherutBoy.entries
                                        .map((e) => Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()), style: TextStyle(color: Colors.black54), maxLines: 3))
                                        .toList()
                                    : []
                                : widget.myPerson.mySherutGirl != null
                                    ? widget.myPerson.mySherutGirl.entries
                                        .map((e) => Text(LocaleText.getLocaleSelectText(MyApp.getLocale(), e.key.toString()), style: TextStyle(color: Colors.black54), maxLines: 3))
                                        .toList()
                                    : [],
                          ),
            ...
            Positioned.fill(child: Align(alignment: Alignment.center, child: circleIcon(FontAwesomeIcons.handHoldingHeart, "שרות"))),
          ]),
        ],
      ),
    );
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    Text(widget.myPerson.gender == Gender.MALE ? LocaleText.getLocaleText(MyApp.getLocale(), 'Him') : LocaleText.getLocaleText(MyApp.getLocale(), 'Her'),
                                        style: TextStyle(fontSize: 18, color: ColorManager().theme.filterBackgroundColor, fontWeight: FontWeight.bold)),
                                    Text(LocaleText.getLocaleText(MyApp.getLocale(), 'Like'),
                                        style: TextStyle(fontSize: 18, color: ColorManager().theme.filterBackgroundColor, fontWeight: FontWeight.bold)),
                                  ],
                                ),
                              )
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: <Widget>[
                                    Text(widget.person.gender == Gender.MALE ? LocaleText.getLocaleText(MyApp.getLocale(), 'Him') : LocaleText.getLocaleText(MyApp.getLocale(), 'Her'),
                                        style: TextStyle(fontSize: 18, color: ColorManager().theme.filterBackgroundColor, fontWeight: FontWeight.bold)),
                                    Text(LocaleText.getLocaleText(MyApp.getLocale(), 'Like'),
                                        style: TextStyle(fontSize: 18, color: ColorManager().theme.filterBackgroundColor, fontWeight: FontWeight.bold)),
                                  ],
