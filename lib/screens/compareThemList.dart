...
import 'package:flutter_app/widgets/compareCard.dart';
                  ...
                  children: <Widget>[
                    if (myListSelected)
                      RaisedButton(
                          ...
                          child: Text(LocaleText.getLocaleText(MyApp.getLocale(), 'My list'),
                              style: TextStyle(
                                  //color: Colors.white
                                  )),
                    ...
                    if (myFavoritesSelected)
                      RaisedButton(
                          ...
                          //color: Theme.of(context).primaryColor,
                          child: Text(LocaleText.getLocaleText(MyApp.getLocale(), 'Favorites'),
                              style: TextStyle(
                                  //color: Colors.white
                                  )),
                          shape: RoundedRectangleBorder(borderRadius: new BorderRadius.circular(30.0))),
                    ...
                    if (allSelected)
                      RaisedButton(
                          ...
                          //color: Theme.of(context).primaryColor,
                          child: Text(LocaleText.getLocaleText(MyApp.getLocale(), 'Everyone'),
                              style: TextStyle(
                                  //color: Colors.white
                                  )),
                          shape: RoundedRectangleBorder(borderRadius: new BorderRadius.circular(30.0))),
