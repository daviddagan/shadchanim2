...
import 'package:flutter_app/widgets/favoritesCard.dart';
    ...
    return (isLoading)
        ...
        : ListView.builder(
            ...
            itemBuilder: (BuildContext ctxt, int index) =>
                returnCard(personProvider.shadchanProvider.myFavoritesList[index], personProvider.shadchanProvider.allShadchanimMap[personProvider.shadchanProvider.myFavoritesList[index].shadchanID]),
          );
  }
