...
import 'package:flutter_app/screens/addPerson.dart';
          ...
          child: Container(
            decoration: BoxDecoration(
              border: Border(
                ...
                right: BorderSide(width: 12.0, color: Colors.black12 //ColorManager().theme.primary[800],
                    ),
              ),
            ),
            child: Column(
              children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: Icon(
                            widget.person.isVisible ? Icons.visibility : Icons.visibility_off,
                ...
                Divider(height: 1, thickness: 1.5, color: Colors.black12 //ColorManager().theme.primary[800],
                    ),
                Container(
                  child: Row(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text(
                              LocaleText.getLocaleText(MyApp.getLocale(), 'viewes'),
                              style: TextStyle(
                                  //color: Colors.grey
                                  ),
                            ),
                      ...
                      Column(
                        children: <Widget>[
                          Text(
                            LocaleText.getLocaleText(MyApp.getLocale(), 'requests'),
                            style: TextStyle(
                                //color: Colors.grey
                                ),
                          ),
                      ...
                      Column(
                        children: <Widget>[
                          Text(
                            LocaleText.getLocaleText(MyApp.getLocale(), 'dates'),
                            style: TextStyle(
                                //color: Colors.grey
                                ),
                          ),
